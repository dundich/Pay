; (function (angular, window, undefined) {
    ...
    angular.module('simple-calendar', []).directive('simpleCalendar', function () {
        return {
            ...
            templateUrl: 'Assets/app/simple-calendar/simple-calendar.html',
            ...
            controller: ['$scope', function ($scope) {
                ...
                bindEvent = function (date) {
                    if (!date || !$scope.events) { return false; }
                    date.event = [];
                ...
                $scope.prevMonth = function () {
                    if (!$scope.allowedPrevMonth()) { return false; }
                ...
                $scope.nextMonth = function () {
                    if (!$scope.allowedNextMonth()) { return false; }
                    var currIndex = MONTHS.indexOf($scope.selectedMonth);
                    if (currIndex === 11) {
                        $scope.selectedYear += 1;
